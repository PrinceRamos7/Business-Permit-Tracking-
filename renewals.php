                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-gradient-info" onclick='editRenewal(<?php echo json_encode($row); ?>)'>
                                                            <i class="mdi mdi-pencil"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-gradient-danger" onclick="deleteRenewal(<?php echo $row['renewal_id']; ?>)">
